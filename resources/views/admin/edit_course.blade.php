                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="/admin_edit_course" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="10" name='details' id="details">{{$item->details}}</textarea>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <input type="file" class="btn btn-primary btn-sm" name='image' id="upload" onchange="readURL(this);">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" name='short_details' id="shortdetails">{{$item->short_details}}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" name='requirements' id="requirement" required>{{$item->requirements}}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for='intro'>Introduction To Course Learning*</label>
                                            <textarea class="form-control" rows="5" name="intro_learn" id="intro" required>{{$item->intro_learn}}</textarea>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="course_content" class="form-control" name="course_content" value="{{$item->course_content}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="url" class="form-control" name="video_url" value="{{$item->full_link}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
