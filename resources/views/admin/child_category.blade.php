                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title text-right">
                                        ...
                                        <a href="/admin_add_child_category" style="margin-top:-5px;margin-left:20px" class="btn btn-default"><i class="fa fa-plus"></i> Add Child Category</a>
                                    </h3>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/admin/childcategory/status/{{$item->id}}" class="btn btn-danger btn-sm">{{$item->status}}</a>
                                                    @else
                                                    <a href="/admin/childcategory/status/{{$item->id}}" class="btn btn-success btn-sm ">{{$item->status}}</a>
                                                    @endif
                                                </td>
                                                <td>
                                                    <a href="/admin_child_category/edit/{{$item->id}}" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i> Edit</a>
                                                </td>
                                                <td>
                                                    <a href="/admin_childcategory/delete/{{$item->id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
                                                </td>
                                            </tr>
